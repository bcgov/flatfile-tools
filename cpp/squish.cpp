/* 20190212 merge: assuming second/last field is studyid, calculate mode of other field */
#include"misc.h"
using namespace std;

int main(int argc, char ** argv){
  cout << argc << endl;
  if(argc < 2) err("usage: merge.cpp [input file: csv, 2 cols] (note: homoiconic property: comments and doc in here should be the same..");
