'''
2019-07-23 apply cohort file and mh-drug list, to concatenated pharmanet data
- product: various
...
if os.path.exists("pnet_druglist.p"):
    ...
    while(True):
        ...
        # extract required fields this line (clean the dinpin for leading zeros even if they aren't there..)
