...
lines = ["Ft_schlstud.A.dat STUDYID SPECIAL_NEED_CODE_THIS_COLL",
         "DAD STUDYID DIAGX1 DSC ADDATE FREQ",
         "MSP STUDYID SPEC ICD9 ICD9_1 ICD9_2 ICD9_3 ICD9_4 ICD9_5 SERVCODE servedate",
         "DES_REP.A DE.STUDYID DE.HLTH_PROD_LABEL DE.DSPD_QTY DE.SRV_DATE",
         "HLTH_REP.A HP.DIN_PIN HP.GEN_DRUG DE.SRV_DATE"]
